  ...
  const services = [
    {
      ...
      description: "Optimize workforce productivity with out customized solutions.",
      link: "#learn-more"
    },
    {
      icon: <HiLightBulb className="w-8 h-8 text-amber-400" />,
      title: "Recruitment", 
      description: "Empower your hiring process with precision tools to attract top talent.",
      link: "#learn-more"
    },
    {
      icon: <FiSettings className="w-8 h-8 text-red-400" />,
      title: "Integration as a Service",
      description: "Achieve unparalled efficiency with our seamless integration solutions.",
      link: "#learn-more"
    },
    {
      icon: <BiTime className="w-8 h-8 text-cyan-400" />,
      title: "Data Migration as a Service",
      description: "Ensure a flawless transition with our expert data migration services.",
      link: "#learn-more"
    }
  ]
       ...
       >
        ...
        >
          ...
          >
            ...
            <span className="text-gray-600">Accelerate your IT Career with NextGen IT Launchpad</span>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            <span className="text-gray-600">Project Initiation Training</span>
          </motion.div>
        </motion.div>
        <motion.button 
