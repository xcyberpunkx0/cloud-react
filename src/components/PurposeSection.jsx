  ...
  const features = [
    {
      ...
      description: "We stay ahead of the curve by leveraging the latest technologies and best practices to provide innovative and efficient solutions"
    },
    {
      icon: "🔴", // Replace with your actual icon component or image
      title: "Deep rooted expertise",
      description: "With years of experience in SAP SuccessFactors, we possess the in-depth knowledge and skills to deliver tailored solutions."
    }
  ];
